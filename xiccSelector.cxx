...
int main(int argc, char **argv) {
  ...
  auto h_df_xi_cc_im_xi_cc_pt_c4_2Hit = df_xi_cc_im_c4_2Hit.Filter(invMassXiccCut, {"fXiccMassStraTrack"}).Histo1D({"df_xi_cc_im_xi_cc_pt_c4_2Hit", "pt selected", 100, 0, 10}, "lPtMCXiCC"); 
