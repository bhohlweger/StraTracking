...
int main(int argc, char **argv) {
  ...
  auto df_precut = df
    ...
    .Filter("TMath::Abs(fPositiveDCAxy)> 0.0025")
    .Filter("TMath::Abs(fPositiveDCAxy)< 5000")
    .Filter("TMath::Abs(fPositiveDCAz )> 0.0025")
    .Filter("TMath::Abs(fNegativeDCAxy)> 0.0025")
    .Filter("TMath::Abs(fNegativeDCAz )> 0.0025")
    .Filter("TMath::Abs(fBachelorDCAxy)> 0.0025")
    .Filter("TMath::Abs(fBachelorDCAz )> 0.0025")
    .Filter("TMath::Abs(fXicPionDCAxyToPV1     )> 0.0010")
    .Filter("TMath::Abs(fXicPionDCAzToPV1      )> 0.0010")
    .Filter("TMath::Abs(fXicPionDCAxyToPV2     )> 0.0010")
    .Filter("TMath::Abs(fXicPionDCAzToPV2      )> 0.0010")
    .Filter("TMath::Abs(fPicDCAxyToPVStraTrack )> 0.0010")
    .Filter("TMath::Abs(fPicDCAzToPVStraTrack  )> 0.0010")
  ...
  auto df_in = (
    ...
    .Filter("TMath::Abs(fXiCCEta)<0.5", "XiccEta")
