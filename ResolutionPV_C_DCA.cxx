...
void DCAPVResolution(const char* howmanycs) { 
  ...
  ca_c_dca_xy_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_topo.Histo1D({"ca_c_dca_xy_pv_topo","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Topo.Data()))); 
  om_c_dca_xy_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_topo.Histo1D({"om_c_dca_xy_pv_topo","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Topo.Data()))); 
  
  ca_c_dca_xy_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_stra.Histo1D({"ca_c_dca_xy_pv_stra","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Stra.Data()))); 
  om_c_dca_xy_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_stra.Histo1D({"om_c_dca_xy_pv_stra","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Stra.Data()))); 
  
  ca_c_dca_xy_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_ca_c_stra_addedHits.Histo2D({"ca_c_dca_xy_pv_stra_addedHits","#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_xy_Stra.Data()))); 
  om_c_dca_xy_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_om_c_stra_addedHits.Histo2D({"om_c_dca_xy_pv_stra_addedHits","#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_xy_Stra.Data()))); 

  ca_c_dca_z_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_topo.Histo1D({"ca_c_dca_z_pv_topo","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Topo.Data()))); 
  om_c_dca_z_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_topo.Histo1D({"om_c_dca_z_pv_topo","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Topo.Data()))); 
  
  ca_c_dca_z_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_stra.Histo1D({"ca_c_dca_z_pv_stra","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Stra.Data()))); 
  om_c_dca_z_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_stra.Histo1D({"om_c_dca_z_pv_stra","#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Stra.Data()))); 
  
  ca_c_dca_z_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_ca_c_stra_addedHits.Histo2D({"ca_c_dca_z_pv_stra_addedHits","#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_z_Stra.Data()))); 
  om_c_dca_z_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_om_c_stra_addedHits.Histo2D({"om_c_dca_z_pv_stra_addedHits","#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_z_Stra.Data()))); 
  ...
  for (int ipt = 0; ipt < ptbins.size()-1; ++ipt) { 
    ...
    ca_c_dca_xy_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_topo_pT.Histo1D({"ca_c_dca_xy_pv_topo"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Topo.Data()))); 
    om_c_dca_xy_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_topo_pT.Histo1D({"om_c_dca_xy_pv_topo"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Topo.Data()))); 
    
    ca_c_dca_xy_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_stra_pT.Histo1D({"ca_c_dca_xy_pv_stra"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Stra.Data()))); 
    om_c_dca_xy_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_stra_pT.Histo1D({"om_c_dca_xy_pv_stra"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_xy_Stra.Data()))); 
   
    ca_c_dca_xy_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_ca_c_stra_pT_addedHits.Histo2D({"ca_c_dca_xy_pv_stra_addedHits"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded",variable_xy_Stra.Data()))); 
    om_c_dca_xy_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_om_c_stra_pT_addedHits.Histo2D({"om_c_dca_xy_pv_stra_addedHits"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_xy_Stra.Data()))); 
    
    ca_c_dca_z_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_topo_pT.Histo1D({"ca_c_dca_z_pv_topo"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Topo.Data()))); 
    om_c_dca_z_pv_topo.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_topo_pT.Histo1D({"om_c_dca_z_pv_topo"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Topo.Data()))); 
    
    ca_c_dca_z_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_ca_c_stra_pT.Histo1D({"ca_c_dca_z_pv_stra"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Stra.Data()))); 
    om_c_dca_z_pv_stra.emplace_back(new ROOT::RDF::RResultPtr<::TH1D>(dfil_om_c_stra_pT.Histo1D({"om_c_dca_z_pv_stra"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 500, 0, 250}, variable_z_Stra.Data()))); 
   
    ca_c_dca_z_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_ca_c_stra_pT_addedHits.Histo2D({"ca_c_dca_z_pv_stra_addedHits"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded",variable_z_Stra.Data()))); 
    om_c_dca_z_pv_stra_addedHits.emplace_back(new ROOT::RDF::RResultPtr<::TH2D>(dfil_om_c_stra_pT_addedHits.Histo2D({"om_c_dca_z_pv_stra_addedHits"+binstring,"#Omega_{c}#rightarrow#Omega+#pi", 10, 0, 10, 500, 0, 250}, "fOmegaHitsAdded", variable_z_Stra.Data()))); 
  }
  
  //Write histos 
  TFile *out = TFile::Open(TString::Format("outResolutionsPVDCA_%s.root", howmanycs), "recreate"); 
  for (int ipt = 0; ipt < ptbins.size(); ++ipt) { 
        
    ca_c_dca_xy_pv_topo[ipt]->GetPtr()->Scale(1./ca_c_dca_xy_pv_topo[ipt]->GetPtr()->Integral()); 
    om_c_dca_xy_pv_topo[ipt]->GetPtr()->Scale(1./om_c_dca_xy_pv_topo[ipt]->GetPtr()->Integral()); 
   
    HarryPlotter::CheckAndStore(out, ca_c_dca_xy_pv_topo[ipt]->GetPtr()); 
    HarryPlotter::CheckAndStore(out, om_c_dca_xy_pv_topo[ipt]->GetPtr()); 
    
    ca_c_dca_xy_pv_stra[ipt]->GetPtr()->Scale(1./ca_c_dca_xy_pv_stra[ipt]->GetPtr()->Integral()); 
    om_c_dca_xy_pv_stra[ipt]->GetPtr()->Scale(1./om_c_dca_xy_pv_stra[ipt]->GetPtr()->Integral()); 
    
    HarryPlotter::CheckAndStore(out, ca_c_dca_xy_pv_stra[ipt]->GetPtr()); 
    HarryPlotter::CheckAndStore(out, om_c_dca_xy_pv_stra[ipt]->GetPtr()); 

    HarryPlotter::Normalize2DBinByBin(om_c_dca_xy_pv_stra_addedHits[ipt]->GetPtr()); 
    HarryPlotter::Normalize2DBinByBin(ca_c_dca_xy_pv_stra_addedHits[ipt]->GetPtr()); 

    HarryPlotter::CheckAndStore(out, om_c_dca_xy_pv_stra_addedHits[ipt]->GetPtr()); 
    ...
    om_c_dca_z_pv_topo[ipt]->GetPtr()->Scale(1./om_c_dca_z_pv_topo[ipt]->GetPtr()->Integral()); 
   
    HarryPlotter::CheckAndStore(out, ca_c_dca_z_pv_topo[ipt]->GetPtr()); 
    HarryPlotter::CheckAndStore(out, om_c_dca_z_pv_topo[ipt]->GetPtr()); 
    
    ca_c_dca_z_pv_stra[ipt]->GetPtr()->Scale(1./ca_c_dca_z_pv_stra[ipt]->GetPtr()->Integral()); 
    om_c_dca_z_pv_stra[ipt]->GetPtr()->Scale(1./om_c_dca_z_pv_stra[ipt]->GetPtr()->Integral()); 
    
    HarryPlotter::CheckAndStore(out, ca_c_dca_z_pv_stra[ipt]->GetPtr()); 
    HarryPlotter::CheckAndStore(out, om_c_dca_z_pv_stra[ipt]->GetPtr()); 

    HarryPlotter::Normalize2DBinByBin(om_c_dca_z_pv_stra_addedHits[ipt]->GetPtr()); 
    HarryPlotter::Normalize2DBinByBin(ca_c_dca_z_pv_stra_addedHits[ipt]->GetPtr()); 

    HarryPlotter::CheckAndStore(out, om_c_dca_z_pv_stra_addedHits[ipt]->GetPtr()); 
    ...
    out->cd(); 
    width_dca_xy_pv_om_c->Write(); 
    width_dca_xy_pv_ca_c->Write(); 
    width_dca_z_pv_om_c->Write(); 
